...
LDA_test.ipynb contains initial exploration of using reading level measures to distinguish smart/witty comedy from silly/absurd/irreverant comedy, profanity checking initial test, and LDA topic modeling using bag-of-words and TF-IDF
